...
export default function TerroirV2() {
  ...
  return (
    <section
      ...
      style={{
        background: `radial-gradient(ellipse 80% 50% at 50% 0%, rgba(45, 74, 43, 0.22) 0%, rgba(20, 33, 12, 0.5) 40%, ${colors.negro} 75%)`,
      }}
    >
      <FloatingParticles />
      <div
      ...
      >
        ...
        >
          Sierra de Segura, 840 metros donde la montaña respira. Inviernos que bajan de 0°C y veranos que superan los 40°C: esa oscilación extrema es lo que hace que el Picual de Peñolite sea inigualable. Suelo calizo, agua de montaña, clima salvaje. La naturaleza hizo su obra maestra. Nosotros solo la cultivamos con respeto.
        </p>
